...
module.exports = async function scrapeMeyer() {
  console.log("\n🔥 MEYER SCRAPER");

  const products = await scrapeAmazon(
    "https://www.amazon.in/s?k=meyer+cookware",
    "Meyer"
  );
  ...
  console.log(`✅ Meyer: ${finalProducts.length} products ready`);
